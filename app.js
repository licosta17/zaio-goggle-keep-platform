...
class App {
    constructor() {
        // How to store and get data from local storage
    ...
    displayNotes() {
        ...
        <div class="note" id="${note.id}" onmouseover= "app.handleMouseOverNote(this)" onmouseout = "app.handleMouseOutNote(this)">
            ...
            <div class="sub-note-title">${note.title}</div>
            <div class="sub-note-text">${note.text}</div>
            <div class="note-footer">
                ...
                <div class="tooltip">
                    ...
                    <span class="tooltip-text">Collaborators</span>
                </div>
                <div class="tooltip">
